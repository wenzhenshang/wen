...
<title>添加链接 - 链接管理 </title>
<meta name="keywords" content="">
<meta name="description" content="">
</head>
<body>
<article class="cl pd-20">
	<form action="/blog/index.php/Admin/Link/add" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="adminName" name="url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">链接说明：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="descrip" cols="" rows="" class="textarea"  placeholder="" dragonfly="true" onKeyUp="textarealength(this,100)"></textarea>
